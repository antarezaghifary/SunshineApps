...
public class CuacaAdapter extends RecyclerView.Adapter<CuacaAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ViewHolder holderBind = holder;
        ListCuacaRepons iteminfo = mDataSet.get(position);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            icon = itemView.findViewById(R.id.icon_cuaca);
            textViewCuaca = itemView.findViewById(R.id.txt_cuaca);
            textViewHari = itemView.findViewById(R.id.text_hari);
            textViewDerajat = itemView.findViewById(R.id.text_derajat);
            textViewDerajat1 = itemView.findViewById(R.id.text_derajat1);
        }
    }
}
